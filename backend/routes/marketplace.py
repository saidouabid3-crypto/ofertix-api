...
from utils.country_intelligence import normalize_country
...
def list_marketplace_items(
    ...
    return {
        ...
        'items': service.list_items(limit=limit, country=country, city=city, category=category),
    }
...
def update_marketplace_item(
    ...
    if not item:
        raise HTTPException(status_code=404, detail='Marketplace item not found or forbidden')
    return item
